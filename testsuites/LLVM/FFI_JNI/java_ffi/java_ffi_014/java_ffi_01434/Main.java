...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Annotation annotation4 = method.getAnnotation(test.InteropTests.class);
    ...
    static void PrintAnnotation(InteropTest anno) {
        ...
        System.out.println("@" + anno.annotationType().getCanonicalName() + "(num=" + anno.num() + ", name=" + anno.name() + ")");
    }
}
